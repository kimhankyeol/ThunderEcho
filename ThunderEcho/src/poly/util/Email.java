...
public class Email {
    ...
    public String setContents(EmailDTO eDTO){
    	...
    	contents += "<html>";
    	contents +="<body>";
		contents += "<div class='texts' style='color: rgb(97, 106, 116); line-height: 22px; padding-left: 10px; font-family: 돋움, Dotum; font-size: 12px;'><b>질문:</b>"+eDTO.getSubject()+"</div>";
		contents += "<div class='texts' style='color: rgb(97, 106, 116); line-height: 22px; padding-left: 10px; font-family: 돋움, Dotum; font-size: 12px;'><b>답변 :</b>"+eDTO.getQa_msg()+"</div>";
    	contents += "</body>";
    	contents += "</html>";
    	return contents;
    };
